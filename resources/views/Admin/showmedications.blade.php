...
<br><br>
<a href="{{route('Medication.create')}}" class="btn btn-outline-primary" id="id">Add Medication</a><br>
<div class="card-body">
    <div class="table-responsive">
        <table class="table text-md-nowrap" id="example1">
            <thead>
                ...
                <th class="wd-15p border-bottom-0">production_date</th>
                <th class="wd-15p border-bottom-0">medical_prescription</th>
                <th class="wd-15p border-bottom-0">picture</th>
                <th class="wd-15p border-bottom-0">Name Category</th>
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td>{{ $m->medical_prescription}}</td>
                        <td>{{ $m->category->name}}</td>
                        <td><img id="im" src="{{ asset('imgs/' . $m->picture)}}" style="width:70px;height:70px">
                        </td>
                        <td>
                            <form action="{{ route('Medication.destroy', $m->id)}}" method="post">
                            @csrf
                            @method('DELETE')
                            ...
                            <a href="{{ route('Medication.edit', $m->id) }}"> <svg xmlns="http://www.w3.org/2000/svg"

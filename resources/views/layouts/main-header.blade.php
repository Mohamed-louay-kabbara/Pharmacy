            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        ...
                        @foreach (Auth::User()->unreadNotifications as $Notification)
                            <a class="d-flex p-3 border-bottom" href="{{route('show_notifications',$Notification->id)}}">
                                <div class="notifyimg bg-pink">
                                    <i class="la la-file-alt text-white"></i>
                                </div>
                                
                                <div class="mr-3">
                                    <h4 class="notification-label mb-1"> لقد تم شراء دواء{{$Notification->data['medication']}} من قبل المستخدم{{$Notification->data['user']}}</h4>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{route('profile.edit',Auth::id())}}"><i class="bx bx-cog"></i> Edit Profile</a>
